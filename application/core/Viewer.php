...
class Viewer
{
    ...
    public function render($filename, $data = null, $theme = 'unitri') //acebootstrap-3.3.7
    {
        ...
        require Config::get('PATH_VIEWER') . '_templates/' . $theme . '/header-mhs.php';
        require Config::get('PATH_VIEWER') . $filename . '.php';
        require Config::get('PATH_VIEWER') . '_templates/' . $theme . '/footer.php';
    }
    ...
    public function renderFeedbackMessages()
    {
        ...
        require Config::get('PATH_VIEWER') . '_templates/default/feedback.php';
