...
class View
{
     ...
     */
    public function render($filename, $data = null, $theme = 'unitri') //acebootstrap-3.3.7
    {
        if ($data) {
        ...
        require Config::get('PATH_VIEW') . '_templates/' . $theme . '/header.php';
        require Config::get('PATH_VIEW') . $filename . '.php';
        require Config::get('PATH_VIEW') . '_templates/' . $theme . '/footer.php';
    }
	
	
	public function renderMhs($filename, $data = null, $theme = 'unitri') //acebootstrap-3.3.7
    {
        if ($data) {
            foreach ($data as $key => $value) {
                $this->{$key} = $value;
        ...
        require Config::get('PATH_VIEW') . '_templates/' . $theme . '/header-mhs.php';
        require Config::get('PATH_VIEW') . $filename . '.php';
        require Config::get('PATH_VIEW') . '_templates/' . $theme . '/footer-mhs.php';
    }
     ...
     * @return bool
     */
    public function renderMulti($filenames, $data = null, $theme = 'default')
    {
     ...
     */
    public function renderFileOnly($filename, $data = null)
    {
        if ($data) {
            foreach ($data as $key => $value) {
                $this->{$key} = $value;
    ...
    public function renderFeedbackMessages()
    {
        ...
        require Config::get('PATH_VIEW') . '_templates/default/feedback.php';
     ...
     */
	 ...
	 public function renderPesanFeedback()
    {
        // echo out the feedback messages (errors and success messages etc.),
        // they are in $_SESSION["feedback_positive"] and $_SESSION["feedback_negative"]
        require Config::get('PATH_VIEW') . '_templates/default/pesan.php';
