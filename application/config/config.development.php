...
// Tell PHP to use specific timezone
...
return array(
    ...
    'PATH_UPLOAD' => realpath(dirname(__FILE__).'/../../') . '/public/file/',
    /**
    ...
    'DEFAULT_TITLE' => 'Universitas Tribhuwana Tunggadewi',
    /**
	...
	*/
    ...
    'EMAIL_PASSWORD_RESET_SUBJECT' => 'Password reset Universitas Tribhuwana Tunggadewi',
    ...
    'EMAIL_VERIFICATION_SUBJECT' => 'Informasi Akun Pendaftaran Mahasiswa Baru ',
    'EMAIL_VERIFICATION_CONTENT' => 'Selamat Pendaftaran Akun Anda Berhasil, Silahkan melengkapi data di http://pmb.unitri.ac.id Berikut data untuk login anda: <br>',
