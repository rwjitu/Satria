...
return array(
    ...
    "FEEDBACK_PASSWORD_WRONG_3_TIMES" => "Anda Memasukkan Password dengan Salah lebih dari 3x. Silahkan tunggu 30 detik dan coba lagi.",
    "FEEDBACK_ACCOUNT_NOT_ACTIVATED_YET" => "Akun Anda Belum Aktif. Mohon Menunggu Aktivasi dari Panitia. Cek Email dan Whatsapp secara berkala",
    "FEEDBACK_USERNAME_OR_PASSWORD_WRONG" => "Username/NIM/email atau PIN/Password salah",
    "FEEDBACK_USER_DOES_NOT_EXIST" => "This user does not exist.",
    "FEEDBACK_LOGIN_FAILED" => "Login Gagal.",
    "FEEDBACK_LOGIN_FAILED_3_TIMES" => "Login Gagal lebih dari 3x. Tunggu 30 detik dan coba lagi.",
    "FEEDBACK_USERNAME_FIELD_EMPTY" => "Username field was empty.",
    "FEEDBACK_PASSWORD_FIELD_EMPTY" => "Password field was empty.",
    "FEEDBACK_USERNAME_OR_PASSWORD_FIELD_EMPTY" => "Username atau password tidak diisi.",
    ...
    "FEEDBACK_email_ALREADY_TAKEN" => "Sorry, that email is already in use. Please choose another one.",
    ...
    "FEEDBACK_ACCOUNT_SUCCESSFULLY_CREATED" => "Akun Anda berhasil dibuat. Silahkan Periksa inbox atau spam email untuk informasi username dan password.",
    ...
    "FEEDBACK_VERIFICATION_MAIL_SENDING_SUCCESSFUL" => "Verifikasi Pemberitahuan Email Sukses.",
    "FEEDBACK_ACCOUNT_ACTIVATION_SUCCESSFUL" => "Aktivasi Akun Sukses! Silahkan login menggunakan informasi yang telah dikirim melalui email.",
    "FEEDBACK_ACCOUNT_ACTIVATION_FAILED" => "Link Aktivasi tidak valid, atau link aktivasi sudah digunakan. ",
    ...
    "INSERT_SUCCESS" => "Insert new data success.",
    "INSERT_FAILED" => "Fail!, can not insert new data.",
    "UPDATE_SUCCESS" => "Perubahan Data Berhasil.",
    "UPDATE_FAILED" => "Gagal!, Tidak dapat merubah data.",
    "DELETE_SUCCESS" => "Delete data success.",
    "DELETE_FAILED" => "Fail!, can not delete data.",
);
