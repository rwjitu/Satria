...
class LoginController extends Controller
{
    ...
    public function index()
    {
        ...
        if (LoginModel::isUserLoggedIn()) {
            ...
            $this->View->renderFileOnly('login/home',
                array(
    ...
    public function login()
    {
        ...
        $login_successful = LoginModel::login(
            Request::post('user_name'), Request::post('user_password'), Request::post('user_rememberme')
        );
        ...
        if ($login_successful) {
            if (Request::post('redirect')) {
                ...
                if (Session::get('user_provider_type') == 'employee') {
                    Redirect::to('employee/detail/' . Session::get('uid'), Session::add('feedback_positive', 'Selamat Datang <strong>'.Request::post('user_name').' </strong> Berhasil login'));
                    exit;
                } else {
    ...
    public function verifyPasswordReset($user_name, $verification_code)
    {
        ...
        if (PasswordResetModel::verifyPasswordReset($user_name, $verification_code)) {
            ...
            $this->View->renderFileOnly('login/resetPassword', array(
                'user_name' => $user_name,
